...
class ModuleController():
    ...
    def create(self, request, created):
        try:
            ...
            request.json[details][self.key] = request.json['domain_name']
            create = api.create(
            ...
            domain = self.getByField(field=request.json['domain_name'])[0]
            ...
            internal.post(
                     ...
                     dictionary={
                         "logging_details":{
                             "module":"domains",
                             "action":"create",
                             "message":"an error occurred when create the domain: {0}".format(
                                request.json['domain_name']
                                ),
                             },
                         "status":"error"}
